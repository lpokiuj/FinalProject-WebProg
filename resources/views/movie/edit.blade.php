    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#addMoreGenre').on('click',function(){
                let html='';
                html+='<select  class="form-select" name="genres" id="genre">';
                html+='<option selected="selected" value="">--Please Select Genre--</option>';
                html+='@foreach($genres as $genre)';
                html+='<option value="{{$genre->id}}">{{$genre->genreName}}</option>';
                html+='@endforeach';
                html+='</select>'; 
                $('#genreInput').append(html);
            })
        })
