...
<div class="container">
    <div class="row">
        <h1 class="text-white my-5">Edit Movie</h1>
    </div>
                    ...
                    <div class="row d-flex align-items-end justify-content-center">
                        <div class="col-md-10">
                            <select class="form-select" name="genreID[]" id="genre">
                                <option selected="selected" value="{{$currentGenre->id}}">{{$currentGenre->genreName}}</option>
                        ...
                        <div class="row ps-4 d-flex align-items-end">
                            <div class="col-md-5 d-flex flex-column">
                                ...
                                <select class="form-select" name="actorID[]" id="actorName">
                                    <option selected="selected" value="{{$currentActor->id}}">{{$currentActor->name}}</option>
                            ...
                            <div class="col-md-5 d-flex flex-column">
                                ...
                                <input type="text" name="charName[]" id="charName" value="{{$currentActor->pivot->charName}}">
                            </div>
                            <button type="button" style="height: 2.5rem; margin-bottom: 0.3rem;" class="deleteButton col-md-2 btn btn-primary" id="delete">Delete</button>
                        </div>
                    </div>
